...
public class Main {
	...
	public static void main(String[] args)
		 ...
		 * implementations of IEntityManager. In this tutorial we create 
		 * an EntityManager on top of Sesame's MemoryStore. 
		 * 
		 * We have to tell this manager to use the Book and Person 
		 * interfaces to encapsulate access to instances and properties 
		 * of Books or Persons. We have to register them as Concepts. 
		 * 
		 * Here we create an entity manager on top of Sesame's 
		 * MemoryStore
		 */
